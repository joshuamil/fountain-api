...
const publishing = require('../controllers').publishing;
...
router.post('/', function(req, res) {
  let id = 0;
  return publishing.create(req, res);
});


// Read Operations
router.get('/', function(req, res) {
  return publishing.list(req, res);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return publishing.retrieve(req, res);
});
...
router.put('/:id', function(req, res) {
  let id = req.params.id;
  return publishing.update(req, res);
});
...
router.patch('/:id', function(req, res) {
  let id = req.params.id;
  return publishing.patch(req, res);
});
...
router.delete('/:id', function(req, res) {
  let id = req.params.id;
  return publishing.delete(req, res);
});
