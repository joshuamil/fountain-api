...
const websitemetadata = require('../controllers').websitemetadata;
...
router.post('/', function(req, res) {
  let id = 0;
  return websitemetadata.create(req, res);
...
router.get('/', function(req, res) {
  return websitemetadata.list(req, res);
  // res.send(`Get route for ${name}`);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return websitemetadata.retrieve(req, res);
...
router.put('/:id', function(req, res) {
  let id = req.params.id;
  return websitemetadata.update(req, res);
...
router.patch('/:id', function(req, res) {
  let id = req.params.id;
  return websitemetadata.patch(req, res);
...
router.delete('/:id', function(req, res) {
  let id = req.params.id;
  return websitemetadata.delete(req, res);
