...
router.post('/', function(req, res) {
  let id = 0;
  return tags.create(req, res);
});


// Read Operations
router.get('/', function(req, res) {
  return tags.list(req, res);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return tags.retrieve(req, res);
});
