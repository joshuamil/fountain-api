...
const exhibititems = require('../controllers').exhibititems;
...
router.post('/', function(req, res) {
  let id = 0;
  return exhibititems.create(req, res);
...
router.get('/', function(req, res) {
  return exhibititems.list(req, res);
  // res.send(`Get route for ${name}`);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return exhibititems.retrieve(req, res);
...
router.put('/:id', function(req, res) {
  let id = req.params.id;
  return exhibititems.update(req, res);
...
router.patch('/:id', function(req, res) {
  let id = req.params.id;
  return exhibititems.patch(req, res);
...
router.delete('/:id', function(req, res) {
  let id = req.params.id;
  return exhibititems.delete(req, res);
