...
router.post('/', function(req, res) {
  let id = 0;
  return versions.create(req, res);
});


// Read Operations
router.get('/', function(req, res) {
  return versions.list(req, res);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return versions.retrieve(req, res);
});
...
router.put('/:id', function(req, res) {
  let id = req.params.id;
  return versions.update(req, res);
});
...
router.delete('/:id', function(req, res) {
  let id = req.params.id;
  return versions.delete(req, res);
});
