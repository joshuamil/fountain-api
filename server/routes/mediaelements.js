...
const mediaelements = require('../controllers').mediaelements;
...
router.post('/', function(req, res) {
  let id = 0;
  return mediaelements.create(req, res);
...
router.get('/', function(req, res) {
  return mediaelements.list(req, res);
  // res.send(`Get route for ${name}`);
});

router.get('/:id', function(req, res) {
  let id = req.params.id;
  return mediaelements.retrieve(req, res);
...
router.put('/:id', function(req, res) {
  let id = req.params.id;
  return mediaelements.update(req, res);
...
router.patch('/:id', function(req, res) {
  let id = req.params.id;
  return mediaelements.patch(req, res);
...
router.delete('/:id', function(req, res) {
  let id = req.params.id;
  return mediaelements.delete(req, res);
